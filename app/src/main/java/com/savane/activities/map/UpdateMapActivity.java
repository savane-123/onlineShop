...
public class UpdateMapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(UpdateMapActivity.this);
        Places.initialize(UpdateMapActivity.this, getString(R.string.google_maps_key));
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Toast.makeText(getApplicationContext(), "address has been updated ",Toast.LENGTH_LONG).show();
                            getAddress(location1, location2, user.getEmail());
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        SettingsClient settingsClient = LocationServices.getSettingsClient(UpdateMapActivity.this);
        Task<LocationSettingsResponse> task = settingsClient.checkLocationSettings(builder.build());

        task.addOnSuccessListener(UpdateMapActivity.this, new OnSuccessListener<LocationSettingsResponse>() {
            @Override
        ...
        task.addOnFailureListener(UpdateMapActivity.this, new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                if (e instanceof ResolvableApiException) {
                    ResolvableApiException resolvable = (ResolvableApiException) e;
                    try {
                        resolvable.startResolutionForResult(UpdateMapActivity.this, 51);
                ...
                .addOnCompleteListener(new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(UpdateMapActivity.this, "unable to get last location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    private void geoLocate()
    {
        ...
        Geocoder geocoder=new Geocoder(UpdateMapActivity.this);
    ...
    public void getAddress(double myLat, double myLong,String email) throws IOException {
        ...
        Call<DefaultResponse> call = RetrofitClient
                .getInstance()
                .getApi()
                .updateAddress(email,fullAddress,String.valueOf(myLong), String.valueOf(myLat),cityName,stateName,countryName1);
